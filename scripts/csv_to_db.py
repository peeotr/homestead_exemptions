...
class csv_to_db:
    def set_input(self, csv_filename):
    ...
    def save_arguments(self):
        ...
        self.csv_filename = self.args.csv_filename
        self.db_name = self.args.db_name
        self.table_name = self.args.table_name

    def parse_arguments(self):
        self.parser = argparse.ArgumentParser(prog="csv to db", description="Takes in a csv file and converts it to a db file")
        self.parser.add_argument("csv_filename", help="Relative path to the .xlsx or .xls file")
    ...
    def convert_to_db(self):
        ...
        df = pd.read_csv(self.csv_filename, dtype=str)
